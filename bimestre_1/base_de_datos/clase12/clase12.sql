...
SELECT idPlaylist AS "Id Playlist", idusuario AS "Id Usuario", titulo AS "Título", cantcanciones 
"Cantidadde canciones", idestado AS "Id Estado", fechacreacion AS "Fecha de Creación", fechaeliminada AS "Fecha Eliminada"
FROM playlist
...
-- Editar todos los artistas que no tengan una imagen cargada y cargarles el texto “Imagen faltante” en la 
-- columna de imagen.
